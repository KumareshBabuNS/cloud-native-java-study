...
public class Jooqreservation extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -239616450;
     ...
     */
    public final TableField<Record, Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_66843D2A_DE20_4AE4_8AA5_DD1BBED7C217)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
